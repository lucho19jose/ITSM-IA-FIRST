...
<head>
    ...
    <title>@yield('title', 'Chuymadesk ITSM')</title>
    <!--[if mso]>
    <noscript>
        <xml>
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                <tr>
                                    <td style="vertical-align: middle;">
                                        ...
                                        @else
                                            <span style="color: #ffffff; font-size: 18px; font-weight: 700;">Chuymadesk</span>
                                        @endif
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td style="border-top: 1px solid #eeeeee; padding: 16px 28px; text-align: center;">
                            <p style="margin: 0; font-size: 12px; color: #999999;">
                                <strong>Chuymadesk</strong> &mdash; Plataforma ITSM
                            </p>
