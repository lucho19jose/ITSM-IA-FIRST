...
description: "Aprende a crear, gestionar y resolver tickets de soporte en Chuymadesk."
order: 10
...
Los tickets son la unidad fundamental de trabajo en Chuymadesk. Cada solicitud de soporte se convierte en un ticket que puede ser rastreado, clasificado y resuelto.
...
Chuymadesk incluye filtros potentes para organizar tickets:
