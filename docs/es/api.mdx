---
title: "REST API"
description: "Documentación de la API REST de Chuymadesk para integrar con tus sistemas existentes."
order: 20
...
Chuymadesk expone una API REST completa para integrar con tus sistemas existentes. Todas las operaciones disponibles en la interfaz web también están disponibles vía API.
