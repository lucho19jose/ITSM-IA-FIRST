...
La Base de Conocimiento (KB) es la biblioteca de artículos de ayuda de Chuymadesk. Los usuarios pueden consultar soluciones antes de crear un ticket, y la IA usa estos artículos para sugerir respuestas.
...
Cuando un usuario está creando un ticket, Chuymadesk muestra artículos relevantes automáticamente. Si el artículo resuelve el problema, el usuario puede cerrar el formulario sin crear el ticket.
...
Chuymadesk puede sugerir la creación de artículos basándose en:
